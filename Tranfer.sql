...
SELECT DISTINCT T.CC_CTR,T.CC_DESC FROM CUSR.CU_MFGPRO_CC_MSTR T WHERE  T.CC_ACTIVE = '1' ORDER BY T.CC_CTR;
SELECT
  T.FAM_FACTORY,
  CU.FACTORY_CODE,
  T.FAM_REQ_TYPE,
...
WHERE
 ...
 SELECT T.FDM_DEPT_SHORT FROM FAM_DEPT_MASTER T WHERE T.FDM_FACTORY = :FACTORY AND T.FDM_STATUS = 'A' ORDER BY T.FDM_SORT,T.FDM_DEPT_SHORT;

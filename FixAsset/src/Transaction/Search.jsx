...
//           {/* Factiory  */}
//           <Grid container spacing={2} className="heardinputAll">
//             <Grid item xs={1.2} className="heardinput"></Grid>
//             <Grid item xs={2} className="heardinput">
...
//               ></TextField>
//             </Grid>
//             <Grid item xs={2} className="heardinput"></Grid>
//           </Grid>

// {/*          
//           <Grid container spacing={1} className="heardinputAll">
//             <Grid container direction="row" className="heardinputOne">
//               <Grid item container xs={5} className="heardinput">
//                 <Grid item xs={12}>
//                   <Typography>FAM No :</Typography>
//                 </Grid>
//               </Grid>
//               <Grid item container xs={6} className="heardinput">
//                 <Grid item xs={12}>
//                   <TextField
//                     id="FamNo"
//                     size="small"
...
//               </Grid>
//             </Grid>
//             <Grid container direction="row" className="heardinputTwo">
//               <Grid item container xs={4} className="heardinput">
//                 <Grid item xs={12}>
...
//               ></TextField>
//             </Grid>
//             <Grid item xs={6} className="heardinput"></Grid>
//           </Grid>
        ...
        <div className="BoxSearch">
          ...
          <Table className="StyleTable1">
            ...
            <TableRow>
              ...
              <TableCell>
                <TextField size="small" value={UserLogin} disabled style={{ width: "100%",}}></TextField>
              </TableCell>
            </TableRow>
            <TableRow>

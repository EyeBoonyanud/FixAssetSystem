  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      const Factory = async () => {
        try {
          const response = await axios.get(
            `http://10.17.74.202:5000/getfactory`
          );
      ...
      const BOI_Project_name = async () => {
        try {
          const response = await axios.get(
            `http://10.17.74.202:5000/get_BOI_project_name`
          );
        ...
        case "ok":
          if (PAGE_STATUS === "NEW") {
            if (
              ...
              try {
                const response = await axios.post(
                  `http://10.17.74.202:5000/ins_BOI_MAINTAIN?FBMC_cost_center=${selectcost[0]}&FBMC_factory=${selecteDatafac[0]}&FBMC_BOI_Project=${BOI_Project}&FBMC_status=${status}&FBMC_comment=${Comment}&FBMC_create_by=${UserLoginn}&FBMC_update_by=${UserLoginn}`
                );
            ...
            if (
              ...
              try {
                const response = await axios.post(
                  `http://10.17.74.202:5000/update_BOI_MAINTAIN?FBMC_cost_center=${selectcost[0]}&FBMC_factory=${selecteDatafac[0]}&FBMC_BOI_Project=${BOI_Project}&FBMC_status=${status}&FBMC_comment=${Comment}&FBMC_update_by=${UserLoginn}`
                );

...
function person_maintain() {
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        const factoryPromise = axios.get(`${import.meta.env.VITE_API}/getfactory`);
        const levelPromise = axios.get(`${import.meta.env.VITE_API}/getlevel`);
        const costPromise = axios.get(`${import.meta.env.VITE_API}/getcost`);
    ...
    if (DATA_SEARCH_S_E !== null) {
      ...
      try {
        ...
        const rollNoSearch = await axios.get(
          `${import.meta.env.VITE_API}/Search_Person_Maintain?FPM_factory=${factoryValue}&FPM_level=${levelValue}&FPM_cost_center=${costValue}&FPM_user_login=${User_LoginValue}`
        );
  ...
  //             `${import.meta.env.VITE_API}/Search_Person_Maintain_Edit?FPM_factory=${factory}&FPM_level=${level}&FPM_cost_center=${cost_center}&FPM_user_login=${user_login}`
  //           );
      ...
      if (willDelete) {
        try {
          const delete_person_maintain = await axios.post(
            `${import.meta.env.VITE_API}/dlt_PERSON_MAINTAIN?FPM_factory_delete=${factory}&FPM_level_delete=${level}&FPM_cost_center_delete=${cost_center}&FPM_user_login_delete=${user_login}`
          );
